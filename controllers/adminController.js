...
module.exports = {
  ...
  actionSignin: async (req, res) => {
    try {
      ...
      if (!user) {
        req.flash("alertMessage", "Kombinasi yang anda masukkan salah!!");
  ...
  actionConfirmation: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Succes Confirmation Pembayarann");
      req.flash("alertStatus", "success");
  ...
  actionReject: async (req, res) => {
    ...
    try {
      ...
      await booking.save();
      req.flash("alertMessage", "Succes Reject Pembayarann");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/booking/${id}`);
    } catch (error) {
      res.redirect(`/admin/booking/${id}`);
